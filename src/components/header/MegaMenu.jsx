...
const MegaMenu = () => {
    ...
    return (
        <div>
            {/*Top Bar */}
                   <div className="sticky  bg-[#100B25] shadow-md text-white">
        ...
        <div className="sticky top-0 z-50 bg-[#00418F] shadow-md flex justify-center ">
            <div className="container flex justify-between items-center py-2">
                ...
                <div className="lg:hidden mr-5">
                    <button className="text-gray-600 font-bold text-2xl" onClick={toggleMobileMenu}>
                        ☰
                    </button>
                </div>
            ...
            {mobileMenuOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 z-40 transition-all">
                    <div className="absolute top-0 left-0 w-4/5 bg-white p-4 h-full">
                        <div className="flex justify-between items-center">
                            <span className="text-lg font-bold">Menu</span>
                            <button onClick={closeMobileMenu} className="text-3xl font-bold">×</button>
                        </div>
                                        ...
                                        <div className="pl-6">
                                            {dropdownContent[item.id]?.items.map((subItem, index) => (
                                                <button 
                                                    ...
                                                    className={`block py-2 ${isRouteActive(subItem.route) ? 'text-[#f78845]' : 'text-gray-700'}`}
                                                >
                                                    {subItem.title}
                                                </button>
                                            ))}
